...
//                        isEnabled = false
        ...
        immediateWebView.webViewClient = object : WebViewClient() {
            ...
            override fun onPageFinished(view: WebView, url: String) {
                ...
                if ((PREFIX + BASE_URL) == url) {
                    val intent = Intent(this@WView, PlActivity::class.java)
                    intent.flags =
                        Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
                    startActivity(intent)
                } else {
                    if (url.isNotEmpty() && !url.contains(BASE_URL) && !(application as App).gf.exists()) {

                        (application as App).gf.write(url)
        ...
        immediateWebView.webChromeClient = object : WebChromeClient() {
            ...
            override fun onCreateWindow(
                ...
                val newWebView = WebView(this@WView)
    ...
    companion object {
        ...
        const val BASE_URL = "egyptlegacy.solutions/"
